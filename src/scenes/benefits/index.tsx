...
const Benefits = ({setSelectedPage}: Props) => {
  ...
  >
     ...
     <p className='my-5 text-sm'>
      We provide world class fitnes equipment, trainers and classes to get you to your ultimate fitness goal with ease. We provide true care into each and every member.
     </p>
